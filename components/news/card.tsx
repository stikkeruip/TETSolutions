        ...
        >
            ...
            <div className="relative w-full pb-[56.25%]"> {/* 16:9 aspect ratio (9/16 = 0.5625 = 56.25%) */}
                ...
                {article.photos && article.photos.length > 0 && (
                    <div className="absolute top-4 right-4 bg-white text-[#013d60] text-xs font-semibold px-3 py-1 rounded-full flex items-center">
            ...
            <div className="p-6 bg-white flex-grow flex flex-col">
                ...
                <div className={`transition-all duration-300 flex-grow ${isHovered ? 'opacity-100 max-h-24' : 'opacity-80 max-h-16'} overflow-hidden`}>
                    <p className="text-[#013d60] text-opacity-80 line-clamp-3">{article.excerpt}</p>
                </div>
