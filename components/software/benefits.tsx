                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 mb-8">
                        {benefits.slice(0, 3).map((benefit, index) => (
                            <div
                                key={benefit.title}
                                className={`bg-white bg-opacity-5 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-[#745e30] border-opacity-30 hover:border-opacity-100 transform hover:translate-y-[-4px] transition-all duration-300 ${
                                    isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                                }`}
                                style={{
                            ...
                            >
                                <div className="flex items-center mb-4">
                                    <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full bg-[#745e30] text-white">
