...
export default function RawMaterialsHero() {
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="h-full w-full overflow-hidden">
                    <img
                        ...
                        alt="Industrial raw materials processing"
                ...
                <div className="absolute inset-0 bg-[#013d60] opacity-50"></div>
            </div>
                ...
                <div className="relative pb-8 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
                    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center lg:text-left pt-16 sm:pt-24 md:pt-32">
                            ...
                            >
                                <span className="block">Quality Raw Materials for</span>{" "}
                                <span
                            ...
                            >
                                Sourcing premium raw materials to support your manufacturing and production requirements with reliability and efficiency.
                            </p>
                            <div
