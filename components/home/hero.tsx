...
export default function Hero() {
  ...
  return (
      <div className="relative overflow-hidden">
        {/* No background here - moved to parent container */}
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="text-center lg:text-left pt-16 sm:pt-24 md:pt-32">
                ...
                >
                  ...
                  >
                    Innovative Technology & Procurement Solutions
                  </span>
                </h1>
                <p
                ...
                >
                  Providing smart, scalable, and secure solutions in procurement, software, raw materials, and EU-funded projects.
                </p>
                <div
